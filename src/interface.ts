import { chess_game} from './chess_engine'; //remember to add .js to interface.js
import { Piece, Depict, Color } from './chess_engine';
// Create a new game board
var game = new chess_game();
...
function check_for_checkmate(game: chess_game, active_col: Color) {
...
function setUpSquareClickEvents() {
    ...
    if (squares) {
        squares.forEach(square => {
            square.addEventListener("click", (event: MouseEvent) => {
...
function visualize_possible_moves(game: chess_game, piece: Piece)  {
...
function remove_possible_moves(game: chess_game) {
...
function get_coordinates(square: HTMLElement): [number, number] {
